...
<body>
    ...
    <section class="row" style="width: 60%;margin: 0 auto;height: 80%">
        ...
        <div class="col-md-8 col-md-offset-2" style="margin-top: -200px">
            <form action="addNewsAction.action" class="fh5co-form animate-box" data-animate-effect="fadeInRight" method="post" style="border-radius: 20px">
                ...
                <div class="form-group">
                    ...
                    <select type="text" class="form-control" id="type" placeholder="新闻类别" name="type">
                        <%
                ...
                <div class="form-group" >
                    <label for="content" class="sr-only">新闻内容</label>
                    <textarea id="content"  placeholder="新闻内容" name="content" rows="5" cols="80"></textarea>
